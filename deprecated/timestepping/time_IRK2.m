...
while (error_nonlinear > nonlinear_acc  && i<nonlinear_maxit)
      ...
      % assemble rhs
      f1(1:Nu)   =  Omu.*ku1 + yConv_ux + yConv_uy + ...
                   -Diffu*u1 - yDiffu - Fx + Gx*p1 + y_px;
                         
      f1(Nu+1:Nu+Nv)  =  Omv.*kv1 + yConv_vx + yConv_vy + ...
                        -Diffv*v1 - yDiffv - Fy + Gy*p1 + y_py;
