...
voi = {
    ...
    'MT', 10; ... % number of temperature modes for reduced order model
    ...
    'dt_snapshots', 0; ...
    'take_all_snapshots', 0; ... 
    'initialize_with_snapshots', 0; ...
    ...
    'weighted_norm_T', 0; ... % 0: unweighted norm; 1: weighted norm (using finite volume sizes as weights)
