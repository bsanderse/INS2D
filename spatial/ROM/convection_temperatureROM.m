function [conv, Jac_conv_T, Jac_conv_V] = convection_temperatureROM(T,V,t,options,getJacobian)
...
T_Ty = AT_Ty*T + yAT_Ty;
conv = CTx*(u_Tx.*T_Tx) + CTy*(v_Ty.*T_Ty);
