% function [obc_hom,obc_inhom,obc_hom_inhom2,obc_hom_inhom,obc_inhom_hom] ...
function [obc_hom,obc_inhom,obc_hom_inhom2] ...
...
for i=1:M
    ...
    elseif options.rom.bc_recon == 2 || options.rom.bc_recon == 0
        ...
        error('Sorry, precomputation not implemented for bc_recon =/= 2,3')
    end
else
    obc_inhom = -666;
    obc_hom_inhom2 = -666;
