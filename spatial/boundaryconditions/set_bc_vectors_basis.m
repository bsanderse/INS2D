function bc_options = set_bc_vectors_basis(t,options,uBC,vBC,dudtBC,dvdtBC)
...
yM     = yMx + yMy;
bc_options.discretization.yM  = yM;
...
if (steady == 0)
    if (options.BC.BC_unsteady==1)
        ...
        bc_options.discretization.ydM = ydM;
    else
        bc_options.discretization.ydM = zeros(Np,1);
    end
end
...
bc_options.discretization.y_px = y_px;
bc_options.discretization.y_py = y_py;
...
bc_options.discretization.yAu_ux = yAu_ux;
bc_options.discretization.yAu_uy = yAu_uy;
bc_options.discretization.yAv_vx = yAv_vx;
bc_options.discretization.yAv_vy = yAv_vy;

if (order4==1)
    bc_options.discretization.yAu_ux3 = yAu_ux3;
    bc_options.discretization.yAu_uy3 = yAu_uy3;
    bc_options.discretization.yAv_vx3 = yAv_vx3;
    bc_options.discretization.yAv_vy3 = yAv_vy3;
end
...
%    Sv_uy           = Sv_uy_BC_lr.B2D*Sv_uy_BC_lu.B2D;
    ...
    switch visc
        case 'laminar'
            ...
            bc_options.discretization.yDiffu = yDiffu;
            bc_options.discretization.yDiffv = yDiffv;
        ...
        case {'keps','LES','qr','ML'}
            ...
            bc_options.discretization.ySu_ux = ySu_ux;
            bc_options.discretization.ySu_uy = ySu_uy;
            bc_options.discretization.ySu_vx = ySu_vx;
            bc_options.discretization.ySv_vx = ySv_vx;
            bc_options.discretization.ySv_vy = ySv_vy;
            bc_options.discretization.ySv_uy = ySv_uy;
    end
...
bc_options.discretization.yIu_ux = yIu_ux;
bc_options.discretization.yIv_uy = yIv_uy;
bc_options.discretization.yIu_vx = yIu_vx;
bc_options.discretization.yIv_vy = yIv_vy;

if (order4==1)
    bc_options.discretization.yIu_ux3 = yIu_ux3;
    bc_options.discretization.yIv_uy3 = yIv_uy3;
    bc_options.discretization.yIu_vx3 = yIu_vx3;
    bc_options.discretization.yIv_vy3 = yIv_vy3;
end
...
switch visc
    ...
    case {'qr','LES','ML'}
        ...
        bc_options.discretization.yAnu_ux = yAnu_ux;
        bc_options.discretization.yAnu_uy = yAnu_uy;
        bc_options.discretization.yAnu_vx = yAnu_vx;
        bc_options.discretization.yAnu_vy = yAnu_vy;        
        ...
        bc_options.discretization.yCux_k = yCux_k;
        bc_options.discretization.yCuy_k = yCuy_k;
        bc_options.discretization.yCvx_k = yCvx_k;
        bc_options.discretization.yCvy_k = yCvy_k;
        bc_options.discretization.yAuy_k = yAuy_k;
        bc_options.discretization.yAvx_k = yAvx_k;
