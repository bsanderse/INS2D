% input file                
% project = 'decaying_turbulence';   % project name used in filenames
...
%%% domain and mesh
    ...
    Nx      = 512;          % number of volumes in the x-direction
    Ny      = 512;          % number of volumes in the y-direction
...
%%% time and space discretization
    ...
    dt            = 1e-3; %5e-4;       % time step (for explicit methods it can be
...
%%% output parameters and visualization
    ...
    rtp.moviename    = 'decaying_turbulence_Re1000'; % movie name
...
%     statistics.n     = 1;
    ...
    save_eco         = 1;          % save unsteady flow field to a file each time step, 
                                   % does not form entire snapshot matrix
