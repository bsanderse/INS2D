...
%     snapshot_data = 'results/shear_layer_ROM_1.000e+100_20x20_g=.1_implicit/matlab_data.mat';
    ...
    for jj = 1:numel(As_)
        ...
        % snapshot_datas_ = [filename '_A=' num2str(A_) ',f=' num2str(f_) ',phi=' num2str(phi_)]; % name of folder where results are saved
        snapshot_datas_ = [filename '_A=' num2str(A_) ',f=' num2str(f_) ',phi=' num2str(phi_) '_forward_euler']; % name of folder where results are saved
        snapshot_datas = [snapshot_datas; string([ snapshot_datas_ '/matlab_data.mat'])];
        
        % snapshot_datas_ = [filename '_A=' num2str(A_) ',f=' num2str(f_) ',phi=' num2str(phi_) '_forward_euler_uv_rotated']; % name of folder where results are saved
        % snapshot_datas = [snapshot_datas; string([ snapshot_datas_ '/matlab_data.mat'])];
...
%%% output parameters and visualization
    ...
    % rtp.moviename    = [filename '_' num2str(j)]; % movie name
    rtp.moviename    = [filename '_A=' num2str(A) ',f=' num2str(f) ',phi=' num2str(phi)]; % movie name
...
%     statistics.n     = 1;
    ...
    % results_name = [filename '_A=' num2str(A) ',f=' num2str(f) ',phi=' num2str(phi)]; % name of folder where results are saved
    results_name = [filename '_A=' num2str(A) ',f=' num2str(f) ',phi=' num2str(phi) '_forward_euler']; % name of folder where results are saved
    % results_name = [filename '_A=' num2str(A) ',f=' num2str(f) ',phi=' num2str(phi) '_forward_euler_uv_rotated']; % name of folder where results are saved
