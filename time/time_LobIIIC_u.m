...
% we don't work with the pressures phi, but with c*phi directly     
% psi1    = a_inv_11*p1 + a_inv_12*p2 + a_inv_13*p3;
% psi2    = a_inv_21*p1 + a_inv_22*p2 + a_inv_23*p3;
% psi3    = a_inv_31*p1 + a_inv_32*p2 + a_inv_33*p3;
...
% our approach also gives second order:
